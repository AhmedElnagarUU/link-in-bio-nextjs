    ...
    <header className="sticky top-0 z-50 w-full border-red-400/20 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto flex h-16 items-center">
        ...
        <div className="flex items-center space-x-4 flex-1 justify-end">
          {isAuthenticated ? (
            <>
              <Link href="/dashboard" className="flex items-center space-x-2 px-3 py-1.5 rounded-full bg-[linear-gradient(135deg,#ff9a56_0%,#ff6b9d_100%)] hover:opacity-90 transition-all text-white">
